...
MODULOS.push({ 
  ...
  sesiones: [
    { 
      ...
      dur: '75 min',
      obj: [
        'Apropiar la naturaleza recursiva e interdependiente de los Ejes A (Yo conmigo mismo) y B (Yo con los otros).',
        'Analizar críticamente el impacto del bienestar y el autocuidado del educador en el clima socioemocional de la clase.',
        'Diseñar e implementar rutinas de co-regulación y sintonía afectiva simétrica en el inicio de la jornada escolar.'
      ],
      contenidos: [
    ...
    { 
      ...
      dur: '75 min',
      obj: [
        'Vincular las acciones locales y la vida democrática del aula con el Eje C (Sociedad) y el Eje D (Mundo).',
        'Articular las problemáticas socioambientales de la región con los marcos globales de sostenibilidad ecológica.',
        'Estructurar bosquejos de proyectos transversales integrados mediante el pensamiento sistémico de interdependencia.'
      ],
      contenidos: [
      ...
      recursos: [
        'Guía Metodológica: "El Enfoque Ecosistémico aplicado al Codiseño de Proyectos de Aprendizaje-Servicio"',
        'Lectura técnica: Bronfenbrenner, U. (1979). Ecología del desarrollo humano (Esquema analítico aplicado)'
      ],
      rq: '¿Tu institución educativa opera de espaldas a las realidades y fracturas socioambientales de su entorno geográfico o las incorpora como insumos de aprendizaje? ¿Qué herida de tu territorio podría ser el núcleo de tu próximo proyecto?',
      aq: '¿Qué tan seguro/a te sientes diseñando proyectos transversales integrados que unan ciencias exactas con la deliberación ética y política del entorno?'
    }
  ],
  ...
  quiz: [
    {
      q: '¿Qué describe el principio de "naturaleza recursiva e interdependiente" en la arquitectura del Modelo Concéntrico (MEN 2026)?',
      opts: [
        'Establece que el desarrollo moral es un proceso lineal y segmentado que obliga al estudiante a aislarse del entorno social hasta dominar su equilibrio interno.',
        'Postula que los círculos se interconectan y retroalimentan continuamente: la forma en que el sujeto se reconoce y cuida (Yo) determina cómo se vincula con los Otros, incide en su participación colectiva (Sociedad) y define su responsabilidad ecológica (Mundo), afectándose recíprocamente.',
        'Determina que las macro-dimensiones del Mundo y la Sociedad anulan por completo la necesidad de atender la salud mental individual del educador.',
        'Representa una lista de contenidos inmodificables diseñada para homogeneizar las programaciones académicas de todas las regiones del país.'
      ],
      c: 1,
    ...
    },
    {
      ...
      opts: [
        ...
        'Delegar la rutina exclusivamente en el departamento de orientación psicológica externa para no restar minutos al dictado temático de la materia.',
        'Emplear la rutina como un filtro disciplinario para sancionar y retirar del salón a los alumnos que muestren indicadores corporales de frustración o tristeza.'
      ],
      c: 1,
      exp: 'La co-regulación exige coherencia metodológica y simetría. El docente actúa como un ancla para el grupo: al exponer sus emociones de manera regulada, normaliza la expresión de la interioridad y provee un andamiaje seguro para que los alumnos aprendan a nombrar y sostener colectivamente sus estados emocionales.'
    }
  ]
});
